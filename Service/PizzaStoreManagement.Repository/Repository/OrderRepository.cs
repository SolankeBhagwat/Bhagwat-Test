...
namespace PizzaStoreManagement.Repository.Repository
{
    public class OrderRepository : IOrderRepository
    {
        ...
        private List<Order> orders = new List<Order> { new Order { OrderId = 1, Pizzas = new List<PizzaOrder> { new PizzaOrder { Id = 1, OrderId = 1, Size = Common.Entities.Enum.PizzaSize.Large } } } };
